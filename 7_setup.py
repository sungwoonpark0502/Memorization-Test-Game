...
def setup(level):
    global display_time
    # how long numbers are shown
    display_time = 5 - (level //3)
    display_time = max(display_time, 1) # if smaller than 1, set as 1
...
def game_over():
    global running
    running = False
    msg = game_font.render(f"Current Level is {curr_level}", True, WHITE)
...
display_time = None # time showing the numbers
start_ticks = None # calculating time
